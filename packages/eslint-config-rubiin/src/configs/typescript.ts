...
import { pluginAntfu, pluginDeprecation, } from '../plugins'
...
export async function typescript(
  ...
  return [
    ...
    {
      files: ['**/*.d.ts'],
      name: 'rubiin:typescript:dts-overrides',
      rules: {
    ...
    },
    {
      ...
      name: 'rubiin:typescript:tests-overrides',
      rules: {
    ...
    {
      files: ['**/*.js', '**/*.cjs'],
      name: 'rubiin:typescript:javascript-overrides',
      rules: {
